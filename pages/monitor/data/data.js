...
Page({
  ...
  drawLine(object) {
    ...
    console.log('sssssseries',paramData.seriesArray)
    ...
    console.log('lineshow', this.data.vueChartHasNodata)
    console.log('lineshow', this.data.hasLeftChart && !this.data.vueChartHasNodataLeft)
  },
  // 处理位移类1
  ...
  openPop(e) {
    ...
    wx.navigateTo({
      url: '/pages/monitor/webview/webview?type=' + type + '&shortName=' + this.data.projectShortName,
    })
    // wx.showLoading({
    //   title: '加载中。。',
    //   mask: true
