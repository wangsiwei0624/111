  ...
  computed: {
    classes: ["prefixCls, pullingText, pullingIcon, disablePullingRotation, refreshingText, refreshingIcon, visible, active, refreshing, tail, prefixLCls, loading, noData", function(t, e, i, n, a, s, o, r, c, l, h, d, f) {
      ...
      return {
        ...
        lPlarceHolder: (0, _classNames5.default)(h, (_defineProperty(holder = {}, "".concat(h, "-holder--hidden"), d), _defineProperty(holder, "".concat(h, "-holder--visible"), !f && !d), holder)),
  ...
  methods: {
    ...
    getTouchPoints: function(t, e) {
      var i = 1 < arguments.length && void 0 !== e ? e : 0,
        n = t.touches[i] || t.changedTouches[i];
      return {
        x: n.pageX,
        y: n.pageY
      }
    ...
    requestAnimationFrame: function(t) {
      var e = this,
        i = (new Date).getTime(),
        n = Math.max(0, 16 - (i - this.lastTime)),
    ...
    finishLoadmore: function(t) {
      ...
      !0 === t ? setTimeout(function() {
        ...
        e.setData({
          noData: !1,
          loading: !1
        }), e.requestAnimationFrame(e.hide), setTimeout(function() {
          return e.deactivate()
        }, 200)
      }, 200)
    },
    ...
    onTouchMove: function(t) {
      !this.start || this.isRefreshing() || this.isLoading() || (this.isMoved || (this.isMoved = !0), this.move = this.getTouchPoints(t), this.diffX = this.move.x - this.start.x, this.diffY = this.move.y - this.start.y, this.direction = this.getSwipeDirection(this.start.x, this.move.x, this.start.y, this.move.y), this.diffY < 0 || "Down" !== this.direction || this.data.noTop || (this.diffY = Math.pow(this.diffY, .8), this.triggerPull(this.diffY)))
    },
    onTouchEnd: function(t) {
      this.isMoved && (this.start = !1, this.isMoved = !1, this.diffY <= 0 || "Down" !== this.direction || this.data.noTop || this.isRefreshing() || this.isLoading() || this.triggerRefresh(this.diffY))
    },
    ...
    doScroll:function(c){
      ...
      this.isMoved || wx.createSelectorQuery().select("#".concat(this.id)).boundingClientRect(function (t) {
        var e = t.height;
        l.data.newContentHeight !== e && l.setData({
          newContentHeight: e
        });
        var i = l.data,
          n = i.oldContentHeight,
          a = i.windowHeight,
          s = i.distance,
          o = i.loading,
          r = i.noData;
        console.log(e - a - 1.5 * s, c);
        a && !l.isRefreshing() && (e - a - 1.5 * s < c && !1 === o && !1 === r && e !== n ? (
          l.setData({
            loading: !0,
            refreshing: !1,
            oldContentHeight: e
          }), console.log(l.data.loading), l.triggerEvent("loadmore")) : !1 === o && !1 === r ? l.hide() : !0 === o && l.setData({
            oldContentHeight: e
          }), l.deactivate())
      }).exec()
    },
